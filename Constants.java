...
public class Constants
{
    ...
    public static final String  TITLE_NAME                  = "Geneko Server";
    ...
    /* device code */
    public static final String  DEVICE_CODE                 = DCServerFactory.GENEKO_NAME;
    ...
    public static final int     MIN_PACKET_LENGTH           = 5;
